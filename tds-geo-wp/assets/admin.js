(function($) {
  ...
  function testConnection() {
    ...
    $.post(tds.ajaxUrl, { action: 'tds_geo_test_connection', nonce: tds.nonce, _ajax_nonce: tds.nonce }, function(r) {
      var ok = !!(r && r.success);
      var message = ok
  ...
  window.revealApiKey = function(keyId) {
    ...
    $.post(tdsGeo?.ajax_url || ajaxurl, {
      action: 'tds_geo_reveal_key', key_id: keyId, password: password, nonce: tdsGeo?.nonce || '', _ajax_nonce: tdsGeo?.nonce || ''
    }, function(r) {
