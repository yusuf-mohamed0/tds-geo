    ...
    public static function get_status(): \WP_REST_Response {
        ...
        return new \WP_REST_Response([
            ...
            'data'    => [
                ...
                'locale'           => get_locale(),
                'api_namespace'    => TDS_GEO_WP_API_NAMESPACE,
                'api_base_url'     => rest_url(TDS_GEO_WP_API_NAMESPACE),
                'webhook_url'      => rest_url(TDS_GEO_WP_API_NAMESPACE . '/webhook'),
                'connector_version'=> TDS_GEO_CONNECTOR_VERSION,
