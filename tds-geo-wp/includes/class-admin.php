...
class Admin {
    ...
    public static function inject_sidebar_logo(): void {
        ...
        (function() {
            ...
            logo.innerHTML = '<img src="<?php echo esc_url(TDS_GEO_WP_URL . 'assets/tds-geo-white.png'); ?>" alt="TDS Geo">';
        ...
        <div class="tds-shell tds-admin-dashboard">
            <div class="tds-nav">
                ...
                <div class="tds-nav-items">
                    ...
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-settings')); ?>" class="tds-nav-item">Settings</a>
            ...
            <div class="tds-gen">
                ...
                <div class="tds-gen-actions">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-keys')); ?>" class="tds-btn tds-btn-primary">Manage API Keys</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-settings')); ?>" class="tds-btn tds-btn-secondary">Settings</a>
    ...
    public static function render_settings(): void {
        ...
        <div class="tds-shell">
            <div class="tds-nav">
                ...
                <span class="tds-nav-title">Traffic Digital Solutions GEO — Settings</span>
                <div class="tds-nav-items">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp')); ?>" class="tds-nav-item">Dashboard</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-settings')); ?>" class="tds-nav-item active">Settings</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-keys')); ?>" class="tds-nav-item">API Keys</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-logs')); ?>" class="tds-nav-item">Logs</a>
                </div>
            </div>
                ...
                <div class="tds-settings">
                    <div class="tds-section">
                        ...
                        <div class="tds-field">
                            ...
                            <div class="tds-desc">Default status for new posts created by TDS Geo. Can be overridden per-article.</div>
                        </div>
                        <div class="tds-field">
                            ...
                            <div class="tds-desc">Default author for posts created by TDS Geo.</div>
                        </div>
                        <div class="tds-field tds-field-checkbox">
                    ...
                    <div class="tds-section">
                        ...
                        <div class="tds-field">
                            ...
                            <code style="display:block;padding:8px 12px;background:var(--tds-bg-elevated);border-radius:var(--tds-radius);"><?php echo esc_url(rest_url(TDS_GEO_WP_API_NAMESPACE . '/webhook')); ?></code>
                            <div class="tds-desc">Configure this URL in your TDS Geo dashboard's webhook settings.</div>
                        </div>
                        <div class="tds-field">
                            <label for="webhook_secret">Webhook Secret</label>
                            <input type="text" name="webhook_secret" id="webhook_secret" value="<?php echo esc_attr($settings['webhook_secret'] ?? ''); ?>">
                            <div class="tds-desc">Optional. If set, TDS Geo will sign payloads with this secret.</div>
                        </div>
                        <div class="tds-field tds-field-checkbox">
    ...
    public static function render_api_keys(): void {
        ...
        <div class="tds-shell">
            <div class="tds-nav">
                <div class="tds-nav-logo"><img src="<?php echo esc_url(TDS_GEO_WP_URL . 'assets/tds-geo-white.png'); ?>" alt="TDS Geo" style="height:28px;width:auto;"></div>
                <span class="tds-nav-title">Traffic Digital Solutions GEO — API Keys</span>
                <div class="tds-nav-items">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp')); ?>" class="tds-nav-item">Dashboard</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-settings')); ?>" class="tds-nav-item">Settings</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-keys')); ?>" class="tds-nav-item active">API Keys</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-logs')); ?>" class="tds-nav-item">Logs</a>
                </div>
            </div>
    ...
    public static function render_logs(): void {
        ...
        <div class="tds-shell">
            <div class="tds-nav">
                <div class="tds-nav-logo"><img src="<?php echo esc_url(TDS_GEO_WP_URL . 'assets/tds-geo-white.png'); ?>" alt="TDS Geo" style="height:28px;width:auto;"></div>
                <span class="tds-nav-title">Traffic Digital Solutions GEO — Activity Logs</span>
                <div class="tds-nav-items">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp')); ?>" class="tds-nav-item">Dashboard</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-settings')); ?>" class="tds-nav-item">Settings</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-keys')); ?>" class="tds-nav-item">API Keys</a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-logs')); ?>" class="tds-nav-item active">Logs</a>
                </div>
            </div>
            ...
            <div class="tds-filter-bar">
                ...
                <a href="<?php echo esc_url(admin_url('admin.php?page=tds-geo-wp-logs&level=info')); ?>" class="tds-btn tds-btn-sm <?php echo $level === 'info' ? 'tds-btn-primary' : 'tds-btn-secondary'; ?>">Info</a>
