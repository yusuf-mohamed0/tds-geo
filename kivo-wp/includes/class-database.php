...
class Database {
    ...
    private const DB_VERSION_OPTION = 'kivo_db_version';
    ...
    public static function run_cleanup(): void {
        ...
        $wpdb->query($wpdb->prepare(
            "DELETE FROM {$wpdb->prefix}kivo_logs WHERE created_at < %s",
    ...
    private static function migrate(): void {
        ...
        if ($current < 1) {
            $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}kivo_logs (
            ...
            $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}kivo_api_keys (
                id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            ...
            $tables[] = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}kivo_articles (
                id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
