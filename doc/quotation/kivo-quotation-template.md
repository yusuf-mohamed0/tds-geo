# Kivo Geo — Professional Quotation Template (Odoo)
...
| 7 | **Letterhead** | Sales → Configuration → Order Layout → Letterhead | Create "Kivo Geo Legal" |
...
|---|---|---|---|---|---|
| Kivo Geo — Setup & Onboarding | Service | TDS-SETUP | $500-2,000 | Ordered quantities | 14% VAT / 0% Export |
| Kivo Geo — Starter (Monthly) | Service | TDS-STARTER-M | $29.00 | Prepaid monthly | 14% VAT / 0% Export |
| Kivo Geo — Starter (Quarterly) | Service | TDS-STARTER-Q | $78.30 | Prepaid quarterly | 14% VAT / 0% Export |
| Kivo Geo — Professional (Monthly) | Service | TDS-PRO-M | $79.00 | Prepaid monthly | 14% VAT / 0% Export |
| Kivo Geo — Professional (Quarterly) | Service | TDS-PRO-Q | $213.30 | Prepaid quarterly | 14% VAT / 0% Export |
| Kivo Geo — Enterprise (Monthly) | Service | TDS-ENT-M | $199.00 | Prepaid monthly | 14% VAT / 0% Export |
| Kivo Geo — Enterprise (Quarterly) | Service | TDS-ENT-Q | $537.30 | Prepaid quarterly | 14% VAT / 0% Export |
...
│  ├───┼───────────────────────────────────────┼─────┼─────────────┼───────┤
│  │ 1 │ Kivo Geo — Starter (Monthly)          │  1  │   $29.00   │ $29.00│
...
5. INTELLECTUAL PROPERTY / الملكية الفكرية
   ...
   5.2 Generated Content: All content, articles, and data generated by the Kivo Geo
       platform specifically for Client becomes Client's property upon full payment.
   5.3 Platform: Provider retains all IP rights to the Kivo Geo platform, software,
   ...
   ٥.٢ المحتوى المُنشأ: جميع المقالات والبيانات التي يولدها نظام Kivo Geo خصيصًا
       للعميل تصبح ملكًا للعميل بعد السداد الكامل.
   ٥.٣ المنصة: يحتفظ المزود بجميع حقوق الملكية الفكرية لمنصة Kivo Geo والبرمجيات
...
| Feature | Typical Odoo Partner | ✅ Kivo Geo Quotation |
|---------|---------------------|---------------------|
...
```
SCOPE OF WORK — Kivo Geo IMPLEMENTATION
...
```
SERVICE LEVEL AGREEMENT — Kivo Geo ENTERPRISE
