...
/**
 * Kivo Geo Next.js Integration - TypeScript Types
 *
 * Mirrors the Kivo Geo backend article/publishing schema for type-safe
...
export interface TdsGeoArticle {
  ...
  /** Arbitrary custom fields from Kivo Geo platform */
...
/** Configuration for the Kivo Geo server integration */
export interface TdsGeoConfig {
  /** API key shared between Kivo Geo and this site */
  apiKey: string;
  /** Where to store content. Defaults to JSON files in .kivo/ */
  storage?: StorageProvider;
  /** ISR revalidation tags to use (default: ['kivo']) */
  revalidationTags?: string[];
  /** Base path for the Kivo Geo API routes (default: '/api/kivo') */
  basePath?: string;
...
export interface StorageProvider {
  ...
  /** Get a single post by its Kivo Geo article ID */
...
/** Webhook event payload from Kivo Geo */
...
/** Props for the Kivo Geo blog components */
