...
/**
 * Kivo Geo Content - Renders Kivo Geo article content with basic styling.
 *
 * Safely renders markdown-or-HTML content into a styled container.
 * Works in both client and server components.
 *
 * @example
 *   import { TdsGeoContent } from '@tds/nextjs-integration/components';
 *
...
export function TdsGeoContent({ content, className = '' }: TdsGeoContentProps) {
  ...
  if (isHtml) {
    return (
      <div
        className={`kivo-content ${className}`}
  ...
  return (
    <div
      className={`kivo-content kivo-content--markdown ${className}`}
