  ...
  surfaces: [
    ...
    },
    {
      ...
      providerCallBoundary: [
        ...
        'adsReports routes support status, dry-run, and generate behind authenticated admin-only access.',
      ],
      artifactBoundary: ['Generated PDF artifacts listed from reports/; internal until CEO/final approval; no report email is sent.'],
      approvalGates: ['admin-only-internal-only'],
      auditTrail: ['route auth and activity_logs for generate/dry-run calls'],
      ...
      currentRisks: ['Lacks an artifact approval/delivery registry; internal-only today with no client-facing automation.'],
      requiredInvariants: ['Keep ads reporting internal-only with no email or client delivery until explicit approval.'],
      nextHardeningStep: 'Add artifact ownership and approval state before any client-facing delivery automation.',
    },
    {
