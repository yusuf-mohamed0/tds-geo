=== KOZMO Core WordPress Integration ===
Contributors: kozmo-core
...
Connect your WordPress site to KOZMO Core — the AI-powered SEO content automation platform. Receive and publish AI-generated articles directly from KOZMO Core.

== Description ==

The KOZMO Core WordPress Integration plugin connects your WordPress site to the KOZMO Core AI SEO Content Automation platform. Once installed and configured, KOZMO Core can:

* **Create posts** directly from the KOZMO Core dashboard
...
* **Receive real-time webhook events** from KOZMO Core
...
1. Upload the `kozmo-core-integration` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to **KOZMO Core → API Keys** and generate an API key
4. Copy the API key and enter it in your KOZMO Core CMS Connection settings
5. Go to **KOZMO Core → Settings** to configure default post status and import preferences
6. Test the connection from the KOZMO Core dashboard or use the 'Test Connection' button

== Frequently Asked Questions ==

= Do I need a KOZMO Core account? =

Yes. This plugin connects your WordPress site to the KOZMO Core AI SEO Content Automation platform. You need an active KOZMO Core account.
...
Yes. You can set the default post status to "Draft" (recommended) so all KOZMO Core-created posts go through your normal review workflow. Articles can also be scheduled for future publication.
