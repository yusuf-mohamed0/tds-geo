(function($) {
  ...
  function generateNow() {
    ...
    $.post(k.ajaxUrl, { action: 'kozmo_ai_generate_now', nonce: k.nonce }, function(r) {
      if (r.success) {
  ...
  function testApiKey() {
    ...
    $result.remove();
    $.post(k.ajaxUrl, { action: 'kozmo_ai_test_api', nonce: k.nonce }, function(r) {
      var html = r.success
  ...
  function dismissMilestone() {
    ...
    if (k.ajaxUrl) {
      $.post(k.ajaxUrl, { action: 'kozmo_ai_dismiss_milestone', nonce: k.nonce });
    }
  }
